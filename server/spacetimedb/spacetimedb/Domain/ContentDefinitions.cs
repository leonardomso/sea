...
public sealed record MapContent
{
    ...
    ///
    /// Generated by scripts/lib/rasterize-maps.mjs from <see cref="Objects"/> in the same pass
    /// that produces <see cref="LandMaskBits"/> below -- never authored by hand, so the grid and
    /// the mask cannot say two different things about the same square.
    /// </summary>
    ...
    /// scripts/lib/rasterize-maps.mjs from <see cref="Objects"/>; never authored by hand.
    /// </summary>
